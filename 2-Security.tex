...
\centering
\begin{table}
\caption{Summary of the categories of contingencies, order of magnitude of their frequency and number, and main challenges in integrating them in a probabilistic security assessment}
\label{tab:contingencies}
...
\TODO{RTE: converters should behave like PI controllers, because too many connection requests per year to build EMT models for everyone}
