...
\addplot+ [ybar interval, fill, mark=none] table [x=id,y=indic_1] {Figs/N_N1.txt};
\addplot+ [mark=none] table [x=id,y=indic_2] {Figs/N_N1.txt};
...
\nextgroupplot[
  ...
  \addplot+ [ybar interval, fill, mark=none] table [x=id,y=indic_1] {Figs/N_N2.txt};
  \addplot+ [mark=none] table [x=id,y=indic_2] {Figs/N_N2.txt};
\addlegendentry{Variance}
\addlegendentry{Coverage}
\end{groupplot}
\end{tikzpicture}
...
\addplot+ [mark=none] table [x expr=\coordindex+1, y=Cost] {Figs/Value_N1.txt};
...
\nextgroupplot[ylabel={Risk [M€/y]}, height=4cm]
\addplot+ [mark=none] table [x expr=\coordindex+1, y=Cost] {Figs/Value_N2.txt};
