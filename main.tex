\documentclass[dvipsnames, twoside, 10pt]{report}
\usepackage{caption}
...
% \usepackage[nomarginpar, headheight=10mm, left=25mm, right=15mm, paperwidth=16cm, paperheight=24cm]{geometry} % For cover page and fancyhdr
\usepackage{geometry}
  \geometry{
    paperwidth=160mm,
    paperheight=240mm,
  %  width=125mm, %ads
  %  height=185mm, %ads
    left=25mm, % Equal margins on both sides: (paperwidth - width) / 2
    right=15mm,
    bottom=25mm,
    headheight=10mm,
  }
