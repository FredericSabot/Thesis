...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Figs/MotorLoad.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{Figs/WECC-composite-load-model.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Figs/IBG.pdf}
...
\begin{adjustbox}{max width=0.45\linewidth}
\begin{tabular}{@{}ccc@{}}
\toprule
...
\subfloat[CIGRE MV network with solar and wind generation~\cite{CIGREMV}]{%
    \includegraphics[width=0.8\linewidth]{Figs/cigre_network_mv.png}
    \label{fig:CIGRE_MV}
...
\begin{axis}[
    ...
    \addlegendentry{5-equivalent  \\ (machine training)}
    \addlegendentry{95-equivalent \\ (machine training)}
...
\begin{figure}
    \centering
    \subfloat[2022 version]{%
        \includegraphics[width=0.75\linewidth]{Figs/Scotland2022.pdf}
    } \\ \vskip 0.9 \baselineskip
    \subfloat[2030 version]{%
        \includegraphics[width=0.75\linewidth]{Figs/Scotland2030.pdf}
    }
    \caption{Representative model of the Scotland power grid~\cite{Sam_thesis}}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Figs/G99_LVRT.png}
...
\begin{figure}
    \centering
    \subfloat[Active power consumption of the equivalent elements (default case)]{%
        \includegraphics[width=0.47\linewidth]{Figs/CIGRE_sensitivities_P.pdf}
    } \hfill
    \subfloat[Reactive power consumption of the equivalent elements (default case)]{%
        \includegraphics[width=0.47\linewidth]{Figs/CIGRE_sensitivities_Q.pdf}
    } \\ \vskip 0.5 \baselineskip
    \centering
    \subfloat[Voltage at the Denny load bus (all cases)]{%
        \includegraphics[width=0.47\linewidth]{Figs/CIGRE_sensitivities_V.pdf}
    }
    \caption{Behaviour of the elements of the 95-equivalent of Denny in the winter 2032 scenario for a fault cleared in 150ms (critical clearing time for default case)}
